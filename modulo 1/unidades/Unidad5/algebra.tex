...
\begin{definicion}[title=Propiedades Clave] \fehandbook{57 (Matrices)}
\begin{itemize}
...
\begin{teorema}[title=Propiedades del Determinante] \fehandbook{58}
...
\textbf{Algoritmo para Diagonalizar Matriz $A$}: \feimply{Algoritmo detallado NO ESTÁ. Solo la definición $Av=\lambda v$.}
\begin{pasos}
