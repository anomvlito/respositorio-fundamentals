\subsection{Técnicas de Integración} \fehandbook{49-50}
...
$$
\fehandbook{49 (Fórmula base)}
\textbf{Estrategia LIATE} para elegir $u$: \textbf{L}ogarítmicas, \textbf{I}nversas, \textbf{A}lgebraicas, \textbf{T}rigonométricas, \textbf{E}xponenciales. \feimply{LIATE no está en el manual.}
\end{tip}

\subsection{Aplicaciones de la Integral Definida}

\begin{definicion}[title=Área entre Curvas] \feimply{Concepto visual. No hay fórmula explícita.}
...
\begin{teorema}[title=Centro de Masa (Centroide)] \fehandbook{108-112 (Sección Estática)}
...
\begin{tip}[title=Resumen de Criterios de Convergencia] \feimply{Manual solo tiene Geométrica (p.50) y Taylor (p.51). TODO lo demás es Memoria.}
\begin{enumerate}
    \item \textbf{Criterio del Término $n$-ésimo (Divergencia):} Si $\lim_{n \to \infty} a_n \neq 0$, la serie diverge.
    
    \item \textbf{Serie Geométrica:} $\sum ar^n$ converge si $|r| < 1$, diverge si $|r| \ge 1$. \fehandbook{50}
