...
\textbf{a)} Comportamiento asintótico (Serie Divergente):
$$
a_n = \frac{\sqrt{n^3(1+2/n^2+\dots)}}{\sqrt{n^5(1+8/n^5)}} \approx \frac{n^{3/2}}{n^{5/2}} = \frac{1}{n}
$$
Usamos el \textbf{Criterio de Comparación en el Límite} con la Serie Armónica $b_n = 1/n$ (que sabemos Diverge):
$$
\lim_{n \to \infty} \frac{a_n}{b_n} = \lim_{n \to \infty} \frac{n \cdot n^{3/2}}{n^{5/2}} = 1
$$
Como el límite es positivo y finito ($c=1$), ambas series se comportan igual. Por lo tanto, \textbf{la serie a) DIVERGE}.
