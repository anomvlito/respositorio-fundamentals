...
\begin{teorema}[title=Método: Variables Separables] \feimply{Método algebraico. No hay fórmula.}
...
\begin{teorema}[title=Método: Factor Integrante (Ec. Lineales 1er Orden)] \fehandbook{51}
...
\begin{pasos}
\item Escribir la \textbf{ecuación característica}: $ar^2 + br + c = 0$. \fehandbook{52 (Homogeneous 2nd Order)}
...
\begin{definicion}[title=Sistema Lineal Homogéneo] \feimply{Teoría de $e^{At}$ explicada aquí NO ESTÁ en matemáticas.}
