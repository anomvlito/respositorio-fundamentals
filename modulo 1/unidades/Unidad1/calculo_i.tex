\subsection{Funciones Elementales y Límites} \fehandbook{36}
...
\textbf{Límites Notables:} \feimply{NO ESTÁN en el manual.}
...
\begin{tip}[title=Reglas de Derivación (Cheat Sheet)] \fehandbook{48 (Derivatives)}
\begin{itemize}
...
\begin{teorema}[title=Teoremas de Existencia (Rigor MAT1610)] \feimply{Memorizar enunciados. No están.}
\begin{itemize}
...
\begin{definicion}[title=Interpretación y Gráfica] \fehandbook{45 (Tests for Critical Points)}
...
\begin{teorema}[title=Tabla de Primitivas Básicas] \fehandbook{49 (Standard Integrals)}
