%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% PREÁMBULO: Aquí se definen las características del documento y los paquetes a usar.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass[12pt]{article}

% Paquetes para matemáticas, idioma y formato
\usepackage[utf8]{inputenc}
\usepackage[spanish]{babel} % Para que use términos en español como "Cuadro"
\usepackage{amsmath}        % Mejores entornos para matemáticas
...
\title{\textbf{Formulario ECF: Módulo de Física (Estática y Dinámica)}}
\author{Basado en Análisis Estratégico y Ejercicios Oficiales}
\date{\today}
...
%-------------------------------------------------------------------------------
\section*{Formulario y Conceptos Clave de Estática y Dinámica}
%-------------------------------------------------------------------------------
...
\subsection*{Estática: El Arte de que las Cosas Permanezcan Quietas ��}
...
\begin{itemize}
    ...
    \item \textbf{Los Detalles Técnicos ⚙️:} Incluye todas las fuerzas externas (aplicadas, reacciones, peso, roce) y momentos externos. Un DCL correcto es el 50% de la solución de cualquier problema de estática.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Los Detalles Técnicos ⚙️:} Esto se traduce en dos ecuaciones vectoriales clave:
    \begin{enumerate}
        \item \textbf{Suma de Fuerzas es Cero:} Evita que el cuerpo se traslade.
        $$ \sum \mathbf{F} = 0 \implies \sum F_x = 0, \quad \sum F_y = 0 $$
...
\begin{itemize}
    ...
    \item \textbf{Los Detalles Técnicos ⚙️:}
        \begin{itemize}
...
%-------------------------------------------------------------------------------
\newpage
\section*{Solución Pregunta 1 (Estática)}
%-------------------------------------------------------------------------------
...
\normalsize
$$ -200 - 1200 + N_B(4 \cdot 0.866) + 0.2 N_B(4 \cdot 0.5) = 0 $$
$$ -1400 + N_B(3.464) + N_B(0.4) = 0 \implies 3.864 N_B = 1400 \implies N_B \approx 362 \, \text{N} $$
...
%-------------------------------------------------------------------------------
\section*{Solución Pregunta 2 (Estática)}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\newpage
\section*{Solución Pregunta 3 (Estática)}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\section*{Solución Pregunta 4 (Estática Conceptual)}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\newpage
\section*{Solución Pregunta 5 (Dinámica - Cinemática)}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\section*{Solución Pregunta 6 (Dinámica - Energía)}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\newpage
\section*{Solución Pregunta 7 (Dinámica - Newton)}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\section*{Solución Pregunta 8 (Dinámica - Momentum)}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\newpage
\section*{Solución Pregunta 9 (Dinámica - Mov. Circular)}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\section*{Solución Pregunta 10 (Dinámica Conceptual)}
%-------------------------------------------------------------------------------
...
\section{Apunte extra ¿Qué es el Movimiento Circular Uniforme?}
...
\section{La Aceleración y la Fuerza Centrípeta}
...
\section{Análisis de Fuerzas y Diagrama de Cuerpo Libre}
...
\subsection{Análisis del Eje Horizontal/Radial (X)}
