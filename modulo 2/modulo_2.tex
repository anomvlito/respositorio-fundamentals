...
\makeatletter
\def\input@path{{./}{unidades/}{modulo 2/}}
\makeatother
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small \sffamily \textbf{Módulo 2: Física y Química}}
...
\title{\textbf{\Huge Fundamentals Resumen} \\ \Large MÓDULO 2: Ciencias Naturales Física y Química}
...
% 1. Dinámica
\input{unidades/01_dinamica.tex}
\newpage

% 2. Electricidad y Magnetismo
\input{unidades/02_electricidad.tex}
\newpage

% 3. Química
\input{unidades/03_quimica.tex}
\newpage

% 4. Termodinámica
\input{unidades/04_termodinamica.tex}
\newpage
