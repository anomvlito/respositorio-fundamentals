...
\definecolor{sectioncolor}{RGB}{150, 0, 80} % Un color más sobrio para ética
\definecolor{noteback}{RGB}{250, 240, 255} % Lila pálido para notas
...
\title{
    \Huge\bfseries
    Guía de Razonamiento y Aplicación Ética \\[0.5cm]
    \Large FIL188: Ética para Ingenieros
}
\author{Una guía para la toma de decisiones profesionales}
\date{Julio de 2025}
\maketitle
\thispagestyle{empty}
\newpage
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Cómo Abordar la Ética Profesional (y no morir en el intento)}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{El Mapa Conceptual de la Ética para Ingenieros}
